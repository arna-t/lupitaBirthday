...
public class BirthdayExample {
  ...
  public static void main(final String[] args) {
     ...
     // HashMap
     HashMap<String, String> birthdayHashMap = new HashMap<>();
    ...
    String name = input.nextLine();
     ...
     System.out.println("birthday=" + birthdayHashMap.get(name));
     ...
     */
    String pathToFile =
      "C:/Users/sjccuser/Documents/GitHub/lupitaBirthday/bday/src/main/java/com/lupita/birthday.json";
    ...
    for (Integer i = 0; i < jsonData.size(); i++) {
      ...
      birthdayHashMap.put(name, birthday);
